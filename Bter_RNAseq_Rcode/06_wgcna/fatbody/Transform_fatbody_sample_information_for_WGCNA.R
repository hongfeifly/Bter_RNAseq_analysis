...
# title: "**Transform fat body sample informatin for
...
samples_infor <- read.table(file = "../data/fatbody_sample_information_star.txt",
                                  header = FALSE)
...
write.csv(samples_information,
          file = "../data/fatbody_sample_information_WGCNA.csv")
